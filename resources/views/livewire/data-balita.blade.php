<div>
    ...
    <div class="flex flex-row gap-2 justify-start items-start">
        <button x-data="" x-on:click.prevent="$dispatch('open-modal', 'tambah-data-balita')"
        ...
        <a href="{{ route('export-pdf-data-balita') }}" target="_blank"
    ...
    {{-- modal --}}
    <x-modal name="tambah-data-balita" :show="$errors->isNotEmpty()" focusable>
        <form wire:submit="{{ $isEdit ? 'updateDataBalita' : 'tambahDataBalita' }}" class="p-6">
            <!-- Modal header -->
            <div class="flex items-center justify-between p-2 border-b rounded-t dark:border-gray-600 border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    {{ $isEdit ? 'Edit' : 'Tambah' }} Data Balita
                </h3>
            ...
            <div class="grid grid-cols-2 mt-6 gap-4">
                <div>
                    ...
                    <x-text-input wire:model="nik_anak" id="nik_anak" name="nik_anak" type="text"
                        class="mt-1 w-full" placeholder="{{ __('NIK ANAK') }}" />

                    <x-input-error :messages="$errors->get('nik_anak')" class="mt-2" />
                </div>
                <div>
                    <x-input-label for="nama_anak" value="{{ __('NAMA ANAK') }}" />

                    <x-text-input wire:model="nama_anak" id="nama_anak" name="nama_anak" type="text"
                        class="mt-1 w-full" placeholder="{{ __('NAMA ANAK') }}" />
                ...
                <div>
                    ...
                    <x-text-input wire:model="nama_ayah" id="nama_ayah" name="nama_ayah" type="text"
                        class="mt-1 w-full" placeholder="{{ __('NAMA AYAH') }}" />
                ...
                <div>
                    ...
                    <x-text-input wire:model="nama_ibu" id="nama_ibu" name="nama_ibu" type="text"
                        class="mt-1 w-full" placeholder="{{ __('NAMA IBU') }}" />
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="message" rows="4" wire:model="alamat"
                        ...
                        placeholder="{{ __('Tulis alamat disini...') }}"></textarea>
                    ...
                    <tr class="bg-white dark:bg-gray-800 capitalize">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex flex-row">
                                ...
                                <button wire:click="editDataBalita({{ $item->id }})" x-data=""
                                    x-on:click.prevent="$dispatch('open-modal', 'tambah-data-balita')"
